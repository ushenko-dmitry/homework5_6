...
public class PropertyConstants {
    ...
    public static final String SQL_REQUEST_INSERT_USER_GROUP = "sql.request.insert.usergroup";
    public static final String SQL_REQUEST_INSERT_USER = "sql.request.insert.user";

    public static final String SQL_REQUEST_SELECT_ALL_USER_GROUPS = "sql.request.select.all.usergroup";
    public static final String SQL_REQUEST_SELECT_ALL_USERS = "sql.request.select.all.user";
    
    public static final String SQL_REQUEST_GET_USER_GROUP_BY_ID = "sql.request.select.usergroup.by.id";

    public static final String SQL_COLUMN_USER_GROUP_ID = "sql.column.usergroup.id";
    public static final String SQL_COLUMN_USER_GROUP_NAME = "sql.column.usergroup.name";
    ...
    public static final String SQL_COLUMN_USER_USER_GROUP_ID = "sql.column.user.user_group_id";
}
